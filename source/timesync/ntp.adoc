...
:ref-huygens: [huygens] Y. Geng et al., "Exploiting a Natural Network Effect for Scalable, Fine-grained Clock Synchronization," in 15th USENIX Symposium on Networked Systems Design and Implementation (NSDI 18), Renton, WA, Apr. 2018, pp. 81-94. https://www.usenix.org/conference/nsdi18/presentation/geng[[Online\]].

<<huygens>> [.aside]#{ref-huygens}# is an NTP-like approach, offering PTP-like time bounds.
