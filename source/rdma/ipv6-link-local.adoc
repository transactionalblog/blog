...
`rdma_rxe` is loaded into your kernel.  All the tools are reporting that you have an RDMA device:
...
And now you're trying to https://www.rdmamojo.com/2015/01/24/verify-rdma-working/[verify RDMA is working].
Except, it isn't. 
