...
expiry=`date --date='now +6 hours' -Iseconds`
...
So, now we get to set up gcloud credentials for some reason?{nospace}sidenote:ref[]
[.aside]#sidenote:def[] Filed https://issues.chromium.org/u/1/issues/428883434[bug 428883434].#
