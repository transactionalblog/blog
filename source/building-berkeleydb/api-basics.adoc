...
struct DB {
   ...
   * @param txnid Ignored. (Allows transactionally creating a database.)
 ...
 *
 * @param dbp A pointer to a DB pointer, which will be non-null after return.
 * @param dbenv Databases can be organized within an environment.  Can be null.
 * @param flags Ignored.  DB_AM_* flags.
 */
